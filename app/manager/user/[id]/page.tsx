  ...
  if (!participant) {
    return (
      <div className="max-w-2xl mx-auto text-center py-32 bg-[#131920]/80 backdrop-blur-3xl border border-white/5 rounded-3xl mt-12 shadow-2xl">
        ...
        <Link href="/manager/participants" className="inline-flex items-center justify-center bg-white text-black font-bold px-8 py-4 rounded-xl transition-all shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:scale-105">
          Return to Registry
        </Link>
      </div>
    )
