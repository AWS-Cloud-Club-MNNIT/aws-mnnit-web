    ...
    >
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button className="hidden md:flex bg-linear-to-r from-[#7C3AED] to-[#5B21B6] hover:opacity-100 transition-all border border-white/10 text-white font-semibold rounded-full px-6 shadow-[0_0_15px_rgba(124,58,237,0.3)] hover:shadow-[0_0_30px_rgba(124,58,237,0.6)]">
            Join Us
          </Button>
